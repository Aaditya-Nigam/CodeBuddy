        ...
        <main className="bg-[#0d1117] min-h-[91.7vh] text-white">
            <div className="h-full mx-auto">
                <div className="flex justify-center pt-4">
                    <p className="bg-green-100 text-green-600 px-4 rounded-2xl text-sm">Version 2.0.0</p>
                </div>
                ...
                <div className="w-[80%] mx-auto grid grid-cols-[3fr_1fr] gap-8 py-8  items-center max-[850px]:flex max-[850px]:flex-col max-[850px]:gap-0">
                    ...
                    <div className="px-4 py-12 grid grid-cols-[1fr_1fr] gap-y-4 gap-x-2">
                        <div className="bg-[#1e232795] px-4 py-2 rounded-lg flex flex-col items-center w-[220px] gap-2 max-[1100px]:w-[200px] max-[950px]:w-[180px] max-[850px]:w-[220px] max-[500px]:w-[160px] transition duration-300 hover:shadow-md shadow-[#ffffff34] cursor-pointer">
